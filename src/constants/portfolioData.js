...
export const projects = [
  {
    ...
    image: "/Screenshot 2026-08-29 130017.png",
    altText: "Techzon Learning Management System dashboard",
    hoverText: "Explore a complete learning ecosystem engineered for students and administrators.",
    shortDescription: "A full-stack learning platform for managing courses, students, enrollments, learning progress, assessments, and administrative workflows.",
    description: "A full-stack learning platform for managing courses, students, enrollments, learning progress, assessments, and administrative workflows.",
    problem: "Managing course registrations, progress tracking, and administrative tasks manually was highly inefficient and prone to error.",
    solution: "Developed a comprehensive platform to handle student learning workflows, course management, and administrative operations efficiently.",
    features: [
  ...
  },
  {
    ...
    image: "/Screenshot 2026-08-29 161611.png",
    altText: "Techzon CRM management dashboard",
    hoverText: "See how business workflows were brought into one operational system.",
    shortDescription: "A business CRM platform designed to manage leads, student records, follow-ups, employee workflows, attendance, assignments, and operational activity from a centralized dashboard.",
    description: "A business CRM platform designed to manage leads, student records, follow-ups, employee workflows, attendance, assignments, and operational activity from a centralized dashboard.",
    problem: "Scattered data across multiple sources created confusion and inefficiencies in managing leads, follow-ups, and employee activities.",
    solution: "Engineered a centralized dashboard integrating lead management, CRM workflows, and attendance tracking into a single operational hub.",
    features: [
      "Lead management",
      "CRM workflows",
  ...
  {
    id: "messenger-crm",
    title: "Email Campaign CRM",
    client: "Email Marketing & Automation",
    github: "https://github.com/Hari-2812/Messenger.git",
    liveUrl: "https://messenger-delta.vercel.app/",
    image: "/Screenshot 2026-08-29 165721.png",
    altText: "Email Campaign CRM dashboard",
    hoverText: "Explore the system behind structured email outreach and campaign management.",
    shortDescription: "A campaign management system for organizing contacts, creating campaigns, managing templates, tracking delivery activity, and streamlining email outreach workflows.",
    description: "A campaign management system for organizing contacts, creating campaigns, managing templates, tracking delivery activity, and streamlining email outreach workflows.",
    problem: "Executing large-scale email campaigns manually without dedicated tools made tracking performance and maintaining contact lists nearly impossible.",
    solution: "Built a robust automation platform capable of managing email templates, orchestrating campaigns, and tracking engagement seamlessly.",
    features: [
      "Contact management",
      "Campaign management",
      "Email templates",
  ...
  },
  {
    ...
    client: "Learning & Progress Management",
    github: "https://github.com/Hari-2812/progress-tracker.git",
    liveUrl: "https://progress-tracker-one-phi.vercel.app/",
    image: "/Screenshot 2026-08-29 165220.png",
    altText: "Bank Aspirant Progress Tracker dashboard",
    hoverText: "See how preparation progress becomes measurable and actionable.",
    shortDescription: "A focused preparation platform that helps bank exam aspirants track study progress, syllabus completion, subject milestones, consistency, and daily preparation activity.",
    description: "A focused preparation platform that helps bank exam aspirants track study progress, syllabus completion, subject milestones, consistency, and daily preparation activity.",
    problem: "Aspirants struggled to maintain consistency and monitor their completion metrics across an extensive syllabus.",
    solution: "Developed an intuitive application that visualizes preparation metrics and tracks daily tasks to ensure structured learning.",
    features: [
      "Syllabus tracking",
      "Subject milestones",
      "Study consistency",
  ...
  },
  {
    ...
    image: "/Screenshot 2026-08-29 170112.png",
    altText: "Analytics Avenue landing page",
    hoverText: "Explore a responsive marketing experience built around conversion and clarity.",
    shortDescription: "A conversion-focused landing page designed to present a data-focused training and placement program with clear messaging, program information, credibility elements, and enrollment CTAs.",
    description: "A conversion-focused landing page designed to present a data-focused training and placement program with clear messaging, program information, credibility elements, and enrollment CTAs.",
    problem: "The training program lacked a dedicated marketing presence to attract students and clearly present course offerings.",
    solution: "Designed and implemented a conversion-focused landing page that effectively communicates program value and drives enrollments.",
    features: [
